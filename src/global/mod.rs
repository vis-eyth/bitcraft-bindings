...
pub struct DbUpdate {
    ...
    blocked_player_state: __sdk::TableUpdate<BlockedPlayerState>,
    ...
    direct_message_state: __sdk::TableUpdate<DirectMessageState>,
    ...
    friends_state: __sdk::TableUpdate<FriendsState>,
